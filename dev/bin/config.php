<?php
/**
 * The functions in this file contain configuration for the init script
 */

/**
 * @return string[] relative paths for files where placeholders will be replaced
 */
function getFilesToUpdate(): array
{
    return [
        'composer.json',
        '.travis.yml',
 ...
 */
function getDefaultVariables(): array
{
    /**
 ...
 */
function getMagentoVersions(): array
{
    return [
        '2.2' => [
            'php'               => ['~7.0', '~7.1', '~7.2'],
